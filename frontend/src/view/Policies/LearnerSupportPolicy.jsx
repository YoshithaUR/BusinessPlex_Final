            ...
            <div className="max-w-4xl mx-auto p-6">
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                        We are committed to providing comprehensive support services for all enrolled students to ensure their success and well-being.
                    </p>
                ...
                <div className="mt-15 mb-10 p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-200">
                    <div className="text-center">
                        <h3 className="text-xl font-semibold text-gray-800 mb-2">Questions about our Learner Support Policy?</h3>
                        <p className="text-gray-600 mb-4">We're here to help you understand the support services available to you.</p>
