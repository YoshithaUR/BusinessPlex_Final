  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="fixed top-[40px] left-0 w-full z-40 bg-white/60 backdrop-blur-md shadow-md">
        <div className="max-w-screen-xl mx-auto flex items-center justify-between px-4 sm:px-6 md:px-12 py-2">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg sm:text-xl font-bold text-blue-800 tracking-wide">Business Plex</span>
          </div>
      ...
      <div className="flex flex-col h-full pt-[88px]">
        ...
        <div className="relative bg-white py-3 px-4 sm:px-6 md:px-12 z-20">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 text-center">
            {highlights.map((item, index) => (
              <div key={index} className="flex flex-col items-center gap-1 group transition-transform duration-300">
        ...
        {/* Marquee Bar - Compact */}
        <div className="w-full py-1 z-30 overflow-hidden" style={{ backgroundColor: "rgb(165, 14, 14)" }}>
      ...
      {showContactButton && (
        <div className="fixed top-[100px] right-4 z-10 transition-opacity duration-500">
          <button
            ...
            className="w-[120px] sm:w-[140px] md:w-[160px] flex justify-center items-center gap-2 bg-[rgb(165,14,14)] text-white px-3 py-2 text-xs sm:text-sm font-semibold hover:bg-orange-600 transition rounded-md shadow-lg"
