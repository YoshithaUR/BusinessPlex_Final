    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      {showScrollTop && (
        <button
          ...
          className="fixed bottom-20 right-6 z-100 bg-[rgb(26,43,60,1)] text-white p-3 rounded-full shadow-lg hover:bg-orange-600 outline-2 outline-white cursor-alias"
